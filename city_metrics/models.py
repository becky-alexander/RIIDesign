...
class CityMetricsElectricInput(models.Model):
	...
	residential_wind_electricity2 = models.DecimalField(max_digits=16, decimal_places=4, blank=True, default=0.00, help_text = "kWh", verbose_name='Residential Electricity (wind generated)')
	com_and_ind_wind_electricity2 = models.DecimalField( max_digits=16, decimal_places=4, blank=True, default=0.00, help_text = "kWh", verbose_name='Commericial & Industrial Electricity (wind generated)')
