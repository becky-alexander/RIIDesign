...
class CityMetricsElectricInput(models.Model):
    ...
    year = models.CharField(max_length=4, help_text='ex: 2012')
    utility_id1 = models.ForeignKey(CityMetricsEnergyUtilities)
    ...
    utility_id2 = models.ForeignKey(CityMetricsEnergyUtilities)
...
class CityMetricsNatGasInput(models.Model):
    ...
    city_id = models.IntegerField()
    year = models.CharField(max_length=4, help_text='ex: 2012')
    utility_ida = models.ForeignKey(CityMetricsEnergyUtilities)
    ...
    utility_idb = models.ForeignKey(CityMetricsEnergyUtilities, null=True, blank=True)
    ...
    utility_idc = models.ForeignKey(CityMetricsEnergyUtilities, null=True, blank=True)
