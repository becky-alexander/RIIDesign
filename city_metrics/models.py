...
class CityMetricsWastewaterInput(models.Model):
    ...
    city_id = models.ForeignKey(City, db_column='city_id', verbose_name='City')
    year = models.CharField(max_length=4, blank=True, choices=YEARS)
    wastewater_facility1_id = models.ForeignKey(CityMetricsWastewaterFacility, null=True, blank=True,  related_name="Facility_I", db_column='wastewater_facility')
    wastewater_treated_facility1 = models.DecimalField(null=True, max_digits=16, decimal_places=4, blank=True)
    wastewater_facility2_id = models.ForeignKey(CityMetricsWastewaterFacility, null=True, blank=True,  related_name="Facility_II", db_column='wastewater_facility')
    wastewater_treated_facility2 = models.DecimalField(null=True, max_digits=16, decimal_places=4, blank=True)
    wastewater_facility3_id = models.ForeignKey(CityMetricsWastewaterFacility, null=True, blank=True,  related_name="Facility_III", db_column='wastewater_facility')
