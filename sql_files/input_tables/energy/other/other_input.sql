...
(
  ...
  other_fuel_type5 INT REFERENCES city_metrics_energy_utilities(id) NOT NULL,
  other_fuel_amount5_residential NUMERIC (16,4) NOT NULL,
  other_fuel_amount5_com_and_ind NUMERIC (16,4) NOT NULL
