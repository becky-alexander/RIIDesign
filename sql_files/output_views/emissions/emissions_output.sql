...
FROM city_metrics_city, city_metrics_travel_intermediary6, city_metrics_waste_city, city_metrics_energy_intermediary1, city_metrics_energy_wn_intermediary2
...
AND city_metrics_waste_city.year = city_metrics_travel_intermediary6.year
AND city_metrics_energy_intermediary1.year = city_metrics_energy_wn_intermediary2.year
AND city_metrics_energy_intermediary1.year = city_metrics_travel_intermediary6.year
AND city_metrics_waste_city.year = city_metrics_energy_wn_intermediary2.year
AND city_metrics_energy_intermediary1.year = city_metrics_waste_city.year
